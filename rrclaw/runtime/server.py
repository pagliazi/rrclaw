...
from rrclaw.tools.pyagent.bridge import PyAgentBridge, register_pyagent_tools
...
class RRClawServer:
    ...
    async def start(self):
        ...
        self.gateway = GatewayChannel(
            ...
            agent_id=self.config.get("gateway", "agent_id", default="rrclaw"),
    ...
    def _get_or_create_runtime(self, session_id: str) -> ConversationRuntime:
        ...
        if session_id not in self._sessions:
            session = Session(
                ...
                session_dir=self.config.get("session", "dir", default="~/.rrclaw/sessions"),
    ...
    def _register_builtin_tools(self):
        ...
        from rrclaw.tools.builtin.bash import BashTool
        from rrclaw.tools.builtin.file_ops import ReadFileTool, WriteFileTool, EditFileTool
        from rrclaw.tools.builtin.market_query import MarketQueryTool
        ...
        try:
            from rrclaw.context.memory.tier2_user import MemoryTool
...
使用 tool_search 搜索更多可用工具。"""
    ...
    def _init_llm_provider(self):
        ...
        try:
            from rrclaw.runtime.providers.router import ProviderRouter
    ...
    def _init_health_monitor(self):
        ...
        try:
            from rrclaw.runtime.resilience.health_monitor import HealthMonitor
