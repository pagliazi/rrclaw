...
Usage:
    python -m rrclaw.tools.mcp.server --backend pyagent
    python -m rrclaw.tools.mcp.server --backend hermes
    python -m rrclaw.tools.mcp.server --backend all
"""
...
logger = logging.getLogger("rrclaw.tools.mcp.server")
...
class RRClawMCPServer:
    ...
    async def _init_pyagent(self):
        ...
        import os
        from rrclaw.tools.pyagent.bridge import PyAgentBridge, PYAGENT_COMMANDS
