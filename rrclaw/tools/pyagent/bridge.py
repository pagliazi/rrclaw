...
from rrclaw.tools.base import Tool, ToolSpec, ToolResult, ToolUse

logger = logging.getLogger("rrclaw.tools.pyagent")
...
def register_pyagent_tools(
    ...
    from rrclaw.tools.registry import ToolIndex
